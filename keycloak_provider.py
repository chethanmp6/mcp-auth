    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            initial_access_token: Optional Keycloak Initial Access Token for DCR. Required if
                anonymous client registration is not enabled in Keycloak.
        """
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=10.0) as client:
                    forward_headers = {
                        ...
                        if key.lower() not in {"host", "content-length", "transfer-encoding", "content-type", "authorization", "origin", "referer"}
                    }
                    forward_headers["Content-Type"] = "application/json"

                    # Add Initial Access Token if configured
                    if self.initial_access_token:
                        forward_headers["Authorization"] = f"Bearer {self.initial_access_token}"
